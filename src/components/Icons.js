...
export const LinkedInIcon = ({ className, ...rest }) => (
  <svg
    ...
    {/* monochrome LinkedIn glyph, uses currentColor */}
    <path
      fill="currentColor"
...
// Back / Chevron Left icon used for page-level back navigation
export const BackIcon = ({ className = '', ...rest }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...rest} aria-hidden>
